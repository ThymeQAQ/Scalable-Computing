...
{
    QString FilePath = QFileDialog::getOpenFileName(this, QStringLiteral("Select File"), "D:/Scalable Computing/Project3/TFTP/TFTP/Tftpd64/Datas");
    ...
    myclient->MyCode.Path = "D:/Scalable Computing/Project3/TFTP/TFTP/RecvFile";
...
{
    QString FilePath = QFileDialog::getOpenFileName(this, QStringLiteral("Select File"), "D:/Scalable Computing/Project3/TFTP/TFTP/RecvFile");
    ui->FileLine->setText(FilePath);
