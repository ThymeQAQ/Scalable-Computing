...
Q_CONSTINIT static const qt_meta_stringdata_CLASSMyClientENDCLASS_t qt_meta_stringdata_CLASSMyClientENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(9, 10),  // "LogWritten"
        QT_MOC_LITERAL(20, 0),  // ""
        QT_MOC_LITERAL(21, 8),  // "RecvData"
        QT_MOC_LITERAL(30, 14)   // "ResendDatagram"
    },
    "MyClient",
    "LogWritten",
    "",
...
void MyClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->LogWritten(); break;
        case 1: _t->RecvData(); break;
        case 2: _t->ResendDatagram(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &MyClient::LogWritten; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
