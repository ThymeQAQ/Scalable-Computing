...
MyClient::MyClient()
{
    ...
    MyCode.Path = "D:/Scalable Computing/Project3/TFTP/TFTP/RecvFile";
...
{
    qDebug()<<"Output LOG！";
    QString MyLog = "D:/Scalable Computing/Project3/TFTP/TFTP/Log";
...
void MyClient::SendRequest(quint16 Port)
{
    ...
    case RRQ:
        ...
        Datagram.append(RRQ);
        Datagram.append(MyCode.FileName.toUtf8());
        Datagram.append(zero);
        Datagram.append(Mode.toUtf8());
        Datagram.append(zero);
        RecordLog(RRQ_SEND);
        break;
    /* write request */
